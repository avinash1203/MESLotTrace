<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MastBom.aspx.vb" Inherits="MESLotTrace.Mast_Bom" %>
...
<body>
    <form id="form1" runat="server" style="z-index: 1; font: calibri; width: auto; height: auto;">
        ...
        <div id="formtitle" runat="server" style="z-index: 1; position: absolute; top: 86px; left: 1px; width: 100%; height: 50px; text-align: center; border: 1px solid black; background-color: azure;">
            <asp:Label ID="frmtitle" runat="server" Style="z-index: 1;" Text="Master Bom" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
        </div>
            ...
            <div id="formcontent" runat="server" style="z-index: 1; position: absolute; width: 99%; height: 491px; border: 1px black solid; top: 55px; left: 4px;">
                <asp:GridView ID="gvContent" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="hhr_rnk_item" HeaderText="Model code" SortExpression="hhr_rnk_item">
                            <ItemStyle Width="100px" />
                        </asp:BoundField>
                ...
                <asp:SqlDataSource ID="MastSetupSDA" runat="server" ConnectionString="<%$ ConnectionStrings:MESLotTraceConnectionString %>" SelectCommand="SELECT [cmp_cd],[plnt_cd],[line_id],[proc_flow_id],[hhr_rnk_item],[step_cd],[equip_cd],[item_cd],[usage_qty],[effective_Fr],[effective_to] FROM [MAST_BOM] WHERE CNCL_FLG = 0"></asp:SqlDataSource>
        ...
        <div id="DataEntryScr" runat="server"
            ...
            <asp:Label ID="Label6" runat="server" Style="z-index: 1; left: 34px; top: 230px; position: absolute" Text="Model code "></asp:Label>
