<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MastReasonMaint01.aspx.vb" Inherits="MESLotTrace.MastReasonMaint01" %>
    ...
    <form id="form1" runat="server" style="z-index: 1; font: calibri; width: auto; height: auto;">
        ...
        <div id="formfoot" style="z-index: 1; position: absolute; top: 698px; left: 1px; width: 100%; height: 48px; border: 1px black; background-color: aqua">
          ...
          <div id="ConfirmDelete" runat="server"
            style="z-index: 9999; position: absolute; top: 50%; left: 786px; transform: translate(-50%,-50%); width: 599px; height: 353px; border: 1px solid black; background-color: #FFCC00;">
