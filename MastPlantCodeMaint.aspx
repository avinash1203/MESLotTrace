<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MastPlantCodeMaint.aspx.vb" Inherits="MESLotTrace.MastPlantCodeMaint" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Master Plant Code Maintenance</title>
    ...
    <form id="form1" runat="server" style="z-index: 1; font: calibri; width: auto; height: auto;">
        <div id="mainform" runat="server" style="z-index: 1; font: calibri; width: auto; height: auto;">
            ...
            <div id="formtitle" runat="server" style="z-index: 1; position: absolute; top: 86px; left: 1px; width: 100%; height: 50px; text-align: center; border: 1px solid black; background-color: azure;">
                <asp:Label ID="frmtitle" runat="server" Style="z-index: 1;" Text="PLANT CODE MAINTENANCE" Font-Bold="True" Font-Size="XX-Large"></asp:Label>
            </div>
                ...
                <div id="formcontent" runat="server" style="z-index: 1; position: absolute; width: 99%; height: 491px; border: 1px black solid; top: 55px; left: 4px;">
                    ...
                    <asp:GridView ID="gvContent" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Pltn_Cd" HeaderText="Plant code" ReadOnly="True" SortExpression="CompCd">
                            <ItemStyle Width="30%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Pltn_Nm" HeaderText="Plant Name" ReadOnly="True" SortExpression="CompNm">
                            <ItemStyle Width="60%" />
                            </asp:BoundField>
                        </Columns>
            ...
            <div id="DataEntryScr" runat="server"
                ...
                <asp:Label ID="Label3" runat="server" Text="PLANT Code Data Entry" Font-Bold="True"
                    Style="z-index: 1; left: 10px; top: 14px; position: absolute; width: 582px; text-align: center"></asp:Label>
                <asp:Label ID="Label4" runat="server" Style="z-index: 1; left: 35px; top: 70px; position: absolute; width: auto;" Text="Plant code"></asp:Label>
                <asp:Label ID="Label5" runat="server" Style="z-index: 1; left: 34px; top: 110px; position: absolute; width: auto;" Text="Plant Name"></asp:Label>


                <asp:TextBox ID="txtPlantCd" runat="server" Style="z-index: 1; left: 218px; top: 69px; position: absolute"></asp:TextBox>
                <asp:TextBox ID="txtPlantNm" runat="server" Style="z-index: 1; left: 218px; top: 109px; position: absolute; width: 318px"></asp:TextBox>
