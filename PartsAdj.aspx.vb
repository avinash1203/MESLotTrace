...
Public Class PartsAdj
    ...
    Private Sub BindGrid()
        ...
        Dim equipId As String = txtEquipID.Text
        Dim itemCd As String = txtPartCode.Text
        Dim vendorCd As String = txtVendorLot.Text
        Dim isZeroQty As Boolean = RBYes.Checked
        Dim sqlQuery As String = Class1.GeneratePartAdjSqlQuery(lineId, procFlowId, stepCd, equipId, itemCd, vendorCd, isZeroQty)
    ...
    Protected Sub gvContent_RowCommand(ByVal sender As Object, ByVal e As GridViewCommandEventArgs) Handles GVContent.RowCommand
        If e.CommandName = "Adjust" Then
            DataEntryScr.Visible = True
            Dim resultArray() As String = e.CommandArgument.Split("_")
            hfTagSeq.Value = resultArray(0)
            txtCqty.Text = resultArray(1)
        End If
    End Sub
    ...
    Private Sub DataEntryScr_Clear()
        txtAty.Text = String.Empty
        txtCqty.Text = String.Empty
        hfTagSeq.Value = String.Empty
    End Sub
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Call CopyRowAndAdjustQty(hfTagSeq.Value, txtAty.Text)
    End Sub
