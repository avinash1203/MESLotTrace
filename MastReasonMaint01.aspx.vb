...
Imports class1
Public Class MastReasonMaint01
          ...
          Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
                    ...
                    gvContent.DataBind()
                    User.Text = "User ID : " & Class1.GetuserName(LoginId)
          ...
          End Sub
          Private Sub Retrieve(ByVal rsncd As String)
                    Dim sqlstr As String
                    Dim cmd As SqlCommand
                    Dim myconnection As New SqlConnection
                    myconnection = New SqlConnection(connstr)
          ...
          Protected Sub btnConfirmDelete_Click(sender As Object, e As EventArgs) Handles btnConfirmDelete.Click
                    ...
                    sqlstr = "UPDATE MAST_REASON SET CNCL_FLG = 9,UPD_DATE='" & updt & "',UPD_ID='" & LoginId & "' " +
                                   "WHERE RSN_CD = '" & txtRSNcd.Text & "'"
                    myconnection.Open()
                    cmd = New SqlCommand(sqlstr, myconnection)
                    Try
                              cmd.ExecuteNonQuery()
          ...
          Protected Sub ImageButton3_Click(sender As Object, e As ImageClickEventArgs) Handles ImageButton3.Click
                    Response.Redirect("Mainpage.aspx?LoginID=" & LoginId)
          End Sub
End Class