    ...
    <form id="form1" runat="server" style="font-family: Calibri;">
        ...
        <div id="mainpage" runat="server" style="z-index: 1; width: 99%; height: auto;">
            ...
            <div id="OperFunc" runat="server" style="z-index: 1; position: absolute; align-content: center; left: 30%; top: 121px; border: solid 1px black; width: 65%; height: 551px; background-color: #CCFFFF;">
                ...
                <asp:Button ID="btnPartAdj" data-key="Part_Adj" runat="server" Style="z-index: 1; left: 30%; top: 136px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Part Adjustment" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnOFRework" data-key="Rework" runat="server" Style="z-index: 1; left: 30%; top: 199px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Rework" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnOFScrap" data-key="Scrap_Item" runat="server" Style="z-index: 1; left: 30%; top: 262px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Scrap item" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnOFPrintTag" data-key="Print_Tag" runat="server" Style="z-index: 1; left: 30%; top: 325px; position: absolute; width: 37%; height: 48px; border-radius: 10px; bottom: 156px;" Text="Print Tag" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnOFTraceAmend" data-key="PLC_Data_Amend" runat="server" Style="z-index: 1; left: 30%; top: 388px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Trace Data Amendment" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
            </div>
            ...
            <div id="MastMaint" runat="server" style="z-index: 1; position: absolute; align-content: center; left: 30%; top: 121px; border: solid 1px black; width: 65%; height: 551px; background-color: #CCFFFF;">
                ...
                <asp:Button ID="btnMMLine" data-key="Maintenance_Line_State" runat="server" Style="z-index: 1; top: 64px; position: absolute; width: 37%; left: 2%; height: 48px; border-radius: 10px;" Text="Line" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMStdUOM" data-key="Standard_UOM" runat="server" Style="z-index: 1; left: 2%; top: 120px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Standard UOM" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMShift" data-key="Shift" runat="server" Style="z-index: 1; left: 2%; top: 176px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Shift" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMProdCapa" data-key="Prod_Capa_shift" runat="server" Style="z-index: 1; left: 2%; top: 233px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Prod. Capa. By Shift" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMProcess" data-key="Process" runat="server" Style="z-index: 1; left: 2%; top: 288px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Process" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMProcess3" data-key="Process3" runat="server" Style="z-index: 1; left: 2%; top: 342px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Process 3" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
 
                <asp:Button ID="btnMMCompCode" data-key="Company_Code" runat="server" Style="z-index: 1; left: 2%; top: 396px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Company code" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMPlantCode" data-key="Plant_Code" runat="server" Style="z-index: 1; left: 2%; top: 452px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Plant Code" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />

                <asp:Button ID="btnMMStep" data-key="Step_Equipment" runat="server" Style="z-index: 1; left: 60%; top: 64px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Step" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMEquip" data-key="Equipment" runat="server" Style="z-index: 1; left: 60%; top: 120px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Equipment" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMStepEquip" data-key="Step_Equipment" runat="server" Style="z-index: 1; left: 60%; top: 176px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Step and Equip. Link" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="BtnMMTraceMast" data-key="Trace_Master" runat="server" Style="z-index: 1; left: 60%; top: 233px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Trace Master" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMConspStep" data-key="Comp_Cons_Step" runat="server" Style="z-index: 1; left: 60%; top: 288px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Comp. Cons by Step" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMReason" data-key="Reason_Master" runat="server" Style="z-index: 1; left: 60%; top: 342px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Reason Master" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
                <asp:Button ID="btnMMWorkerReg" Visible="false" data-key="Worker_Registration" runat="server" Style="z-index: 1; left: 60%; top: 396px; position: absolute; width: 37%; height: 48px; border-radius: 10px;" Text="Worker Registration" Font-Names="Arial Rounded MT Bold" Font-Size="20px" BackColor="#0000FF" ForeColor="#FFFFFF" />
            </div>
