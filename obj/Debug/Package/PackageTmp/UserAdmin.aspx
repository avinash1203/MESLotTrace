...
<body>
    <form id="form1" runat="server" style="z-index: 1; font: calibri; width: auto; height: auto;">
        ...
        <div id="DataEntryScr" runat="server"
            ...
            <asp:DropDownList ID="ddUserRole" runat="server" Style="z-index: 1; left: 218px; top: 186px; position: absolute; width: 164px" AccessKey="r">
            ...
            <asp:DropDownList ID="ddUserStatus" runat="server" Style="z-index: 1; left: 218px; top: 227px; position: absolute; width: 150px">
        ...
        <div id="AccessDataEntryScr" runat="server"
            ...
            <asp:CheckBox ID="cb5" runat="server" AutoPostBack="true" Checked="false" Style="z-index: 1; left: 632px; top: 170px; position: absolute" Text="Reporting" Font-Bold="True" Font-Size="12pt" />
            ...
            <asp:CheckBox ID="cb6" runat="server" AutoPostBack="true" Checked="false" Style="z-index: 1; left: 823px; top: 170px; position: absolute" Text="Import from SAP" Font-Bold="True" Font-Size="12pt" />
            ...
            <asp:CheckBox ID="cbExporttoSAP" runat="server" AutoPostBack="true" Checked="false" Style="z-index: 1; left: 1015px; top: 170px; position: absolute" Text="Export to SAP" Font-Bold="True" Font-Size="12pt" />
