...
<body>
    <form id="form1" runat="server" style="z-index: 1; font: calibri; width: auto; height: auto;">
        ...
        <div id="formtitle" runat="server" style="z-index: 1; position: absolute; top: 86px; left: 1px; width: 100%; height: 50px; text-align: center; border: 1px solid black; background-color: azure;">
            <asp:Label ID="frmtitle" runat="server" Style="z-index: 1;" Text="SCRAP/REWORK " Font-Bold="True" Font-Size="XX-Large"></asp:Label>
    <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/BackBlue01v1.png" Style="z-index: 1; left: 95%; top: 8px; position: absolute; width: 50px; height: 38px" Width="25px" />
     ...
     <asp:Label ID="Label4" runat="server" style="z-index: 1; left: 11px; top: 17px; position: absolute" Text="Note : System will allow individual or Mass upload" Font-Italic="True"></asp:Label>
                    ...
                    <asp:Label ID="Label1" runat="server" Style="position: absolute; z-index: 1; left: 2%; top: 90px" Text="Serial Number" Font-Size="X-Large"></asp:Label>
                    <asp:TextBox ID="txtSNo" runat="server" Style="z-index: 1; left: 29%; top: 92px; position: absolute; width: 420px; height: 30px;" BorderStyle="Solid" Font-Size="Large"></asp:TextBox>
                    <asp:Button ID="btnProcess" runat="server" CssClass="button1" Font-Bold="True" Font-Size="X-Large" Style="z-index: 1; left: 18%; top: 401px; position: absolute; width: 389px; height: 50px" Text="Process Scrap/Rework" />
                    <asp:Button ID="btnExit" runat="server" CssClass="button1" Font-Bold="True" Font-Size="X-Large" Style="z-index: 1; left: 60%; top: 401px; position: absolute; width: 230px; height: 50px" Text="EXIT" />
                                        <asp:Label ID="Label3" runat="server" Style="position: absolute; z-index: 1; left: 2%; top: 160px" Text="Upload File" Font-Size="X-Large"></asp:Label>

                  <asp:Label ID="Label2" runat="server" Style="position: absolute; z-index: 1; left: 2%; top: 230px" Text="Operation Type" Font-Size="X-Large"></asp:Label>

                    <asp:FileUpload ID="FileUpload1" runat="server" style="z-index: 1; left: 29%; top: 152px; position: absolute; width: 590px" Font-Size="Large" BorderStyle="Solid" />
               <asp:Label ID="Label5" runat="server" Font-Italic="True" Font-Size="Small" ForeColor="#FF0066" style="z-index: 1; left:29%; top: 208px; position: absolute" Text="File in CSV format"></asp:Label>

                  <asp:Label ID="Label6" runat="server" Style="position: absolute; z-index: 1; left: 2%; top: 300px" Text="Select Reason Code" Font-Size="X-Large"></asp:Label>

                    <asp:DropDownList ID="ddReasonCode" runat="server" style="z-index: 1; left: 29%; top: 301px; position: absolute; width: 424px; " Font-Size="Large">
                    </asp:DropDownList>

                    <asp:RadioButton ID="rbScrap"  runat="server"  GroupName="aa" Style ="z-index: 1; left: 29%; top: 234px; vertical-align : middle; height: 33px; width:203px; position: absolute; right: 672px;" Text="SCRAP" Checked="True" AutoPostBack="True" OnCheckedChanged ="rbScrap_checked" Font-Size="Large" />
                    <asp:RadioButton ID="rbRework" runat="server" GroupName="aa" style="z-index: 1; left: 567px; top: 235px; position: absolute" Text="REWORK" AutoPostBack="True" OnCheckedChanged ="rbRework_checked" Font-Size="Large" />
